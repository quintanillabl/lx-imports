...
<content tag="header">Ventas posibles de asignación</content>
			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-title">
					    ...
					    <a id="asignar" class="btn btn-outline btn-success">Asignar</a>
					</div>
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#asignar").on('click',function(){
				...
				var ok=confirm('Asignar factura al la nota:'+${pago.id}+'?');
				if(!ok)
					return;
				$.post(
					"${createLink(action:'asignarFactura')}",
					{id:${pago.id},facturas:JSON.stringify(res)})
				.done(function(data){
