			...
			<div class="row row-header">
				<div class="col-md-8 col-sm-offset-2 toolbar-panel">
					<div class="btn-group">
					    <lx:backButton/>
					    <lx:createButton/>
					    <lx:editButton id="${aduanaInstance?.id}"/>
					    <lx:printButton/>
					</div>
				</div>
			</div> <!-- End .row 1 -->
			<div class="row">
			    <div class="col-md-8 col-sm-offset-2">
					<div class="panel panel-primary">
						<div class="panel-heading"> ${entityName}: ${aduanaInstance} </div>
						<g:if test="${flash.message}">
					  	...
					  	<div class="panel-body">
					  		<g:form class="form-horizontal">
					  			...
					  			<f:display property="nombre" bean="aduanaInstance"/>
					  					
					  			
					  					
					  			<f:display property="direccion" bean="aduanaInstance"/>
