			...
			<div class="row row-header">
				<div class="col-md-8 col-sm-offset-2 toolbar-panel">
					<div class="btn-group">
					    <lx:backButton/>
					    <lx:printButton/>
					    <lx:deleteButton bean="${aduanaInstance}"/>
					</div>
				</div>
			</div> <!-- End .row 1 -->
			    ...
			    <div class="col-md-8 col-sm-offset-2">
					...
					<div class="panel panel-primary">
						<div class="panel-heading"> 
							<g:message code="default.edit.label" args="[entityName]" />: ${aduanaInstance} 
						</div>
						<g:if test="${flash.message}">
					  	...
					  	<div class="panel-body">
				  			...
				  			<g:hiddenField name="version" value="${aduanaInstance?.version}" />
				  			<f:all bean="aduanaInstance"/>
					  	</div>
