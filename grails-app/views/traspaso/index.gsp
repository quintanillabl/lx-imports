...
<content tag="header">
	 Traspaso entre cuentas (Periodo: ${session.periodoTesoreria.asPeriodoText()})
</content>
	        ...
	        <div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content">
	            	<table id="grid" class="grid table table-responsive table-striped table-bordered table-hover">
	            		...
	            		<tbody>
	            			<g:each in="${traspasoInstanceList}" var="row">
	            				<tr>
	            					<td>
	            					...
	            					<td>${fieldValue(bean: row, field: "cuentaOrigen.nombre")} (${fieldValue(bean: row, field: "cuentaOrigen.numero")})</td>
	            					<td>${fieldValue(bean: row, field: "cuentaDestino.nombre")} (${fieldValue(bean: row, field: "cuentaDestino.numero")})</td>
