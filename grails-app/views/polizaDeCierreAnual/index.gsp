	        ...
	        <div class="ibox float-e-margins">
	        	...
	        	<div class="ibox-title">
	        		...
	        		<div class="btn-group">
	        		    ...
	        		    <ul class="dropdown-menu">
	        		    	<li>
	        		    		<g:link action="generarPoliza" onclick="return confirm('Generar cierre anual para el periodo ${session.periodoContable.ejercicio}');">
	        		    			<i class="fa fa-cog "></i> Generar</a>
	        		    		</g:link>
	        		    	</li>
